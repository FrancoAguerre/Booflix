<?php
    ...
    $res = mysqli_query($conn, "SELECT * FROM genres ORDER BY desc_spa ASC");
?>
<html>
<head>
    ...
    <div id="for-footer">
        <div class="top-bar ">
            <div class=" top-bar-area  ">
                ...
                <div style="padding:8px"> </div>
                <div class=" top-bar-link-selected" href="genres.php">
                    Géneros
                </div>
                <div style="padding:8px"> </div>
            ...
            <div class="top-bar-area ">
                <form id="search-form" method="GET" class="search-box " action="search.php" onsubmit="return validateSearchBox()">
                    ...
                    <input name="type" type="hidden" value="3"></input>
