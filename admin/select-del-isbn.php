...
<form action="select-del-chapter.php" method="POST" enctype="multipart/form-data">
<br>
<p>ISBN :  <input type="text" name="isbn" size='30' maxlength="13" minlength="13" placeholder = "Ingrese el ISBN del libro deseado" ></p>
<p>
