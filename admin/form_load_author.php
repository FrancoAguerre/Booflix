...
<div align = "center" class= "absolute-center" style = "border:1px solid gray; padding: 16px; border-radius: 6px;" ><h1> CARGA AUTOR </h1>

<form align = "center" action="authorsDB.php" method="POST">
 <br>
