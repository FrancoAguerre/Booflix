...
<div align='center' class= "absolute-center" style = "border:1px solid gray; padding: 16px; border-radius: 6px; "><h1>USUARIOS REGISTRADOS</h1>
<form align = "center" action="view_users_per_monthDB.php" method="POST">
